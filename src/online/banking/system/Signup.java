...
public class Signup extends JFrame implements ActionListener {
    ...
    Signup() {
       ...
       // auto set the location of the frame in center 
        ...
        // Added by iae to remember the application form no. 
        JOptionPane.showMessageDialog(null, "Remeber the APPLICATION FORM NO. It will be needed for the next procedure");
    }
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        try {
            if (t6.getText().equals("")) {
                JOptionPane.showMessageDialog(null, "Fill all the requireds fields");
            } else {
                conn c1 = new conn();
